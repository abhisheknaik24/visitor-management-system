...
public class NewClientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uri = "http://"+IpAddressActivity.ipAddress+"/database/addClient.php";

        imageView = (ImageView) findViewById(R.id.imageViewClient);
        firstName = (EditText) findViewById(R.id.editTextTextClientFirstName);
        lastName = (EditText) findViewById(R.id.editTextTextClientLastName);
        phone = (EditText) findViewById(R.id.editTextTextClientPhone);
        location = (EditText) findViewById(R.id.editTextTextClientLocation);
        companyName = (EditText) findViewById(R.id.editTextTextClientCompanyName);
        purpose = (EditText) findViewById(R.id.editTextTextClientPurpose);
        reference = (EditText) findViewById(R.id.editTextTextClientReference);
        capture = (Button) findViewById(R.id.buttonCaptureClient);
        add = (Button) findViewById(R.id.buttonClientAdd);

        if (ContextCompat.checkSelfPermission(NewClientActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(NewClientActivity.this, new String[]
                    {
    ...
    public void clientAdd(String string){
